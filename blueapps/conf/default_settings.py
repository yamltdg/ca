...
# OTEL TRACE
BKAPP_OTEL_BK_DATA_TOKEN = os.getenv("OTEL_BK_DATA_TOKEN", "")
BKAPP_OTEL_GRPC_HOST = os.getenv("OTEL_GRPC_URL", None)
BKAPP_OTEL_SAMPLER = os.getenv("OTEL_SAMPLER", "parentbased_always_off")
